...
class UsageHistoryCard extends StatelessWidget {
  const UsageHistoryCard({super.key, required this.paymentHistory});

  final UsageHistoryEntity paymentHistory;

  @override
  Widget build(BuildContext context) {
    final isPending = paymentHistory.status == UsageHistoryStatus.pending;
              ...
              Expanded(
                child: Column(
                  ...
                  children: [
                      ...
                      children: [
                        Expanded(
                          child: Row(
                            ...
                            children: [
                              Text(
                                _getTypeLabel(paymentHistory.type),
                                style: TextStyle(
                    ...
                    SizedBox(height: 4.h),
                    Text(
                      'เลขที่เอกสาร: ${paymentHistory.id}',
                      style: TextStyle(
                        fontFamily: 'Kanit',
                        fontSize: 13.sp,
