...
import 'package:flutter_pat_application/shared/widgets/appbar/custom_app_bar.dart';
import 'package:flutter_pat_application/shared/widgets/equipmentListWidgets/equipmentItemWidget.dart';
...
class _EquipmentListState extends State<EquipmentListScreen> {
    ...
    List<String> itemsImage = ["lib/assets/images/ic_list-table_01.png",
...
// Choose a random image from itemsImage list
    final randomImage = itemsImage[Random().nextInt(itemsImage.length)];
          ...
          setState(() {
            ...
            itemsMock = response.data.data.map((data) {
              return EquipmentItem(
                ...
                nameImage: randomImage,  // Replace with actual dynamic image if needed
              );
            }).toList();
          });
        }
