...
import '../widgets/invoicet_card.dart';
...
class _InvoiceScreenState extends ConsumerState<InvoiceScreen> {
  ...
  Widget _buildTabBar() {
    return Container(
      height: 48.h,
      decoration: BoxDecoration(
        color: const Color(0xFF009ADB).withOpacity(0.1),
      ...
      child: TabBar(
        ...
        indicator: BoxDecoration(
          color: const Color(
            0xFF003D6B,
          ), // Darker blue for active tab matching design
        ...
        unselectedLabelColor: const Color(0xFF009ADB),
  ...
  Widget _buildListView(List<InvoiceEntity> invoices) {
    if (invoices.isEmpty) {
      return Center(
        child: Column(
