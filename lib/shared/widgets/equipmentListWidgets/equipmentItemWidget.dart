...
class EquipmentItemWidget extends StatelessWidget {
  ...
  const EquipmentItemWidget({super.key, required this.item ,
          ...
          child: Padding(
            ...
            child: Column(
              ...
              children: [
                ...
                Text('หมวดพัสดุ :${item.category}', style: const TextStyle(fontSize: 14, color: Colors.grey)),
                Text('รายการพัสดุ " ${item.description}', style: const TextStyle(fontSize: 14, color: Colors.black)),
                Text('สำนักงาน/ส่วนงาน : ${item.location}', style: const TextStyle(fontSize: 14, color: Colors.black)),
              ],
            ),
          ),
        ),
